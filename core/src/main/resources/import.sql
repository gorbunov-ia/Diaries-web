...
insert into t_Notes (UserID ,Description ,SortBy ,LastModified) select U.ID ,D.Description ,0 ,CURRENT_DATE from t_Users AS U cross join ( select 'Тест' as Description ) as D where U.Login = 'test';
